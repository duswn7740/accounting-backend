...
const getTrialBalanceQuery = `
  ...
  FROM accounts a
  LEFT JOIN (
    SELECT gvl.account_code, gvl.debit_amount, gvl.credit_amount, gv.voucher_date, gv.company_id
    FROM general_voucher_lines gvl
    INNER JOIN general_vouchers gv ON gvl.voucher_id = gv.voucher_id
    UNION ALL
    SELECT spvl.account_code, spvl.debit_amount, spvl.credit_amount, spv.voucher_date, spv.company_id
